	...
	public static void main(String[] arg) throws Exception {
		...
		if (arg.length < 1) {
			...
			case 18:
				...
				M1.rapportLogKLog((double)5);
				res[1] = M1.getRes();

				M1.rapportLogKLog((double)10);
				res[2] = M1.getRes();

				M1.rapportLogKLog((double)20);
				res[3] = M1.getRes();
			...
			case 26:
				...
				M1.rapportKpN2pN((double)9);
				res[2] = M1.getRes();

				M1.rapportKpN2pN((double)12);
				res[3] = M1.getRes();
			...
			case 27:
				...
				M1.rapport2pNKpN((double)9);
				res[2] = M1.getRes();

				M1.rapport2pNKpN((double)12);
				res[3] = M1.getRes();
