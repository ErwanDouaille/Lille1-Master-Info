...
MainWindow::MainWindow() :
  ...
  format.setVersion(2,1); // there's a bug somewhere for the compatibility profile on AMD driver : comment this line if there's a problem with the openGL version
  ...
  _choice.push_back(new QPushButton("Subdivision +/-")); // choice 1
  _choice.push_back(new QPushButton("Clear points")); // ...
  _choice.push_back(new QPushButton("Sub 4")); // ...
