...
Vector2 Camera::windowToNDC(double x, double y) {
...
bool Camera::windowToCamera(double x, double y, Vector3 *mouseCam) {
...
Vector3 Camera::windowToCamera(double x,double y) {
  Vector3 res;
