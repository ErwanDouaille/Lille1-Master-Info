...
void Quaternion::set(const Vector3 &ii,const Vector3 &jj,const Vector3 &) {
  ...
  *this=q*q2;
  ...
  /* // something s wrong (tried many formulas from internet; none is correct (i.e q*(1,0,0), q*(0,1,0), q*(0,0,1) dont (always) give ii,jj,kk (unit tests))
  Vector3 i=ii;
  Vector3 j=jj;
  Vector3 k=kk;
  i.normalize();
